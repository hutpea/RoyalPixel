...
public class ConfigBuild
{
    ...
    private static string KeyStorePath = "Assets/01_BirdSort/KeyStore/birdsort.keystore";

    private const string folderPath = "BirdSort_Final";
    ...
    {
        string localPath = "Assets/MyGame/Scenes/Loading.unity";
    ...
    {
        string localPath = "Assets/MyGame/Scenes/Home.unity";
        EditorSceneManager.SaveCurrentModifiedScenesIfUserWantsTo();
        EditorSceneManager.OpenScene(localPath);
    }
    ...
    {
        string localPath = "Assets/MyGame/Scenes/GamePlay.unity";
        EditorSceneManager.SaveCurrentModifiedScenesIfUserWantsTo();
        EditorSceneManager.OpenScene(localPath);
    }
    ...
    {
        string localPath = "Assets/01_BirdSort/Scenes/CreatLevel.unity";
        EditorSceneManager.SaveCurrentModifiedScenesIfUserWantsTo();
        EditorSceneManager.OpenScene(localPath);
    }
    ...
    {
        string localPath = "Assets/01_BirdSort/Scenes/TestLevel.unity";
        EditorSceneManager.SaveCurrentModifiedScenesIfUserWantsTo();
        EditorSceneManager.OpenScene(localPath);
    }
    [MenuItem("Open Scene/GamePlayPvP1")]
    public static void OpenSceneGamePlayPvP1()
    {
        string localPath = "Assets/01_BirdSort/Scenes/GamePlayPvP1.unity";
        EditorSceneManager.SaveCurrentModifiedScenesIfUserWantsTo();
        EditorSceneManager.OpenScene(localPath);
    }
    [MenuItem("Open Scene/HomeScenePvP")]
    public static void OpenHomeScenePvP()
    {
        string localPath = "Assets/01_BirdSort/Scenes/HomeScenePvP.unity";
        EditorSceneManager.SaveCurrentModifiedScenesIfUserWantsTo();
        EditorSceneManager.OpenScene(localPath);
    }
