...
namespace UnityEngine.UI.Extensions
{
    ...
    public class ScrollConflictManager : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        private HorizontalScrollSnap scrollerParentSnap;
        ...
        void Awake()
        {
            //ParentScrollRect = UIMain.instance.ParentScrollRect;
            //Get the current scroll rect so we can disable it if the other one is scrolling
            _myScrollRect = this.GetComponent<ScrollRect>();
            scrollerParentSnap = ParentScrollRect.gameObject.GetComponent<HorizontalScrollSnap>();
        ...
        public void OnBeginDrag(PointerEventData eventData)
        {
            ...
            _myScrollRect.OnBeginDrag(eventData);
            if (scrollOtherHorizontally)
            {
                if (horizontal > vertical)
                {
                    ...
                    scrollerParentSnap.OnBeginDrag(eventData);
                }
            }
        ...
        public void OnEndDrag(PointerEventData eventData)
        {
            ...
            if (scrollOther)
            {
                ...
                //scrollerParentSnap.OnEndDrag(eventData);
            }
        }
        ...
        public void OnDrag(PointerEventData eventData)
        {
            ...
            if (scrollOther)
            {
                ...
                //scrollerParentSnap.OnDrag(eventData);
            }
        }
    }
}