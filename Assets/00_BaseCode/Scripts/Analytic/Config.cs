...
public class Config
{
    public static string settingProductName = "Royal Art Pixel";

    public const string settingKeyStore = "royalart";
    public static string keyaliasPass = "12345678two";
    public static string keystorePass = "12345678two";
    public static string settingAliasName = "royalart";

    public const string settingLogo = "GAME_ICON";

    public static int versionCode = 2024050403;//sua
    public static string versionName = "2.2.4";//sua
    public static int settingVersionCode = 2024050403;//sua
    public static string settingVersionName = "2.2.4";//sua

    public static string productNameBuild = "Royal Art Pixel";
...
#if UNITY_ANDROID
    public const string package_name = "com.gplay.royal.art.pixel.color";
#else
    public const string package_name = "com.gplay.royal.art.pixel";
#endif
