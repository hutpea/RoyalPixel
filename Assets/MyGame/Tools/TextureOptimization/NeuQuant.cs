namespace Tools.TextureOptimization
{
	...
	{
		protected static int netsize = 50;
		...
		protected static int netbiasshift = 4;

		protected static int ncycles = 100;

		protected static int intbiasshift = 16;

		protected static int intbias = 1 << intbiasshift;

		protected static int gammashift = 10;

		protected static int gamma = 1 << gammashift;

		protected static int betashift = 10;

		protected static int beta = intbias >> betashift;

		protected static int betagamma = intbias << gammashift - betashift;

		protected static int initrad = netsize >> 3;

		protected static int radiusbiasshift = 6;

		protected static int radiusbias = 1 << radiusbiasshift;

		protected static int initradius = initrad * radiusbias;

		protected static int radiusdec = 30;

		protected static int alphabiasshift = 10;

		protected static int initalpha = 1 << alphabiasshift;

		protected int alphadec;

		protected static int radbiasshift = 8;

		protected static int radbias = 1 << radbiasshift;

		protected static int alpharadbshift = alphabiasshift + radbiasshift;

		protected static int alpharadbias = 1 << alpharadbshift;
		...
		public NeuQuant(byte[] thepic, int len, int sample, int colorsCount)
		{
			thepicture = thepic;
			lengthcount = len;
			samplefac = sample;
