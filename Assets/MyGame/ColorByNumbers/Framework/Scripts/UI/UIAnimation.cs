...
namespace BizzyBeeGames
{
	public class UIAnimation : MonoBehaviour
	{
		...
		public static void SwapText(Text uiText, string text, float duration)
		{
			...
			UIAnimation fadeOutAnim = UIAnimation.Color(uiText, toColor, duration / 2f);
			...
			fadeOutAnim.OnAnimationFinished += (GameObject obj) => 
			{
				...
				// Fade it back in
				UIAnimation fadeInAnim = UIAnimation.Color(uiText, toColor, duration / 2f);
		...
		public static UIAnimation FadeOut(Graphic graphic, float duration, float delay = 0)
		{
			Color toColor = graphic.color;

			toColor.a = 0f;

			UIAnimation fadeOutAnim = UIAnimation.Color(graphic, toColor, duration);

			fadeOutAnim.style		= UIAnimation.Style.EaseOut;
			fadeOutAnim.startDelay	= delay;
		...
		public static UIAnimation FadeIn(Graphic graphic, float duration, float delay = 0)
		{
			Color toColor = graphic.color;

			toColor.a = 1f;

			UIAnimation fadeInAnim = UIAnimation.Color(graphic, toColor, duration);

			fadeInAnim.style		= UIAnimation.Style.EaseOut;
			fadeInAnim.startDelay	= delay;
