...
public class ImageImportWindow : EditorWindow
{
    ...
    private string DefaultOutputFolder { get { return AssetDirectory + "/MyGame/AreasFile/"; } }
    ...
    private void DrawImportSettings(Rect drawRect)
    {
        ...
        if (chooseClicked)
        {
            string choosenFolder = EditorUtility.OpenFilePanel("png", "", "");
            importTexture = LoadPNG(choosenFolder);
        }
