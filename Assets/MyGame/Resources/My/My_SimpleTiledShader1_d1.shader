  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(OUT_Data_Vert in_f)
      {
          ...
          float4 tmpvar_3;
          tmpvar_3 = (tex2D(_MainTex, texcoord_2) * in_f.xlv_COLOR);
          col_1.xyz = float3(tmpvar_3.xyz);
          col_1.w = (tmpvar_3.w * _Alpha);
          col_1.w = (col_1.w * _Alpha1);
          out_f.color = col_1;
          return out_f;
      }
