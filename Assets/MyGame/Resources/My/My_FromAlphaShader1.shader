  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          ...
          if((_Inverted>0))
          {
              float _tmp_dvx_66 = (1 - tmpvar_2.w);
              c_1.xyz = float3(_tmp_dvx_66, _tmp_dvx_66, _tmp_dvx_66);
          }
          else
          {
              c_1.xyz = float3(c_1.www);
          }
          c_1.w = (_Alpha * _Alpha1);
          out_f.color = c_1;
          return out_f;
      }
