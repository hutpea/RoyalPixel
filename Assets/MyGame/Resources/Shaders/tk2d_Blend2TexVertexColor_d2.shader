Shader "tk2d/Blend2TexVertexColor1"
{
  Properties
  {
  ...
  SubShader
  {
    ...
    Pass // ind: 1, name: 
    {
      ...
      OUT_Data_Vert vert(appdata_t in_v)
      {
          ...
          tmpvar_2 = tmpvar_1;
          tmpvar_3.xy = float2(in_v.texcoord.xy);
      ...
      OUT_Data_Frag frag(v2f in_f)
      {
          OUT_Data_Frag out_f;
          float4 tmpvar_1;
          tmpvar_1 = ((tex2D(_MainTex, in_f.xlv_TEXCOORD0.xy) * tex2D(_GradientTex, in_f.xlv_TEXCOORD0.zw)) * in_f.xlv_COLOR);
